...
def check_required_by(requirements, module_parameters, add_required=None, none_is_not_specified=True, none_warnings=None):
    ...
    for (key, value) in requirements.items():
        if key not in module_parameters or (none_is_not_specified and module_parameters[key] is None):
            if key in module_parameters and none_warnings is not None:
        ...
        for required in value:
            if required not in module_parameters or (none_is_not_specified and module_parameters[required] is None):
